module.exports = {
  ...
  htmlWhitespaceSensitivity: 'strict', // https://prettier.io/docs/en/options.html#html-whitespace-sensitivity
  endOfLine: 'lf', // https://prettier.io/docs/en/options.html#end-of-line
 };
